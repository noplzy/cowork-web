...
--
-- Name: cowork_room_friend_action_v4a("uuid", "uuid", "uuid", "text", "text"); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE OR REPLACE FUNCTION "public"."cowork_room_friend_action_v4a"("p_actor_user_id" "uuid", "p_target_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_message" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."cowork_room_friend_action_v4a"("p_actor_user_id" "uuid", "p_target_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_message" "text") OWNER TO "postgres";

--
-- Name: FUNCTION "cowork_room_friend_action_v4a"("p_actor_user_id" "uuid", "p_target_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_message" "text"); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION "public"."cowork_room_friend_action_v4a"("p_actor_user_id" "uuid", "p_target_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_message" "text") IS 'P4-A service-role-only atomic room friend state transition. Next.js must authenticate the actor first.';


--
-- Name: cowork_room_owner_action_v4a("uuid", "uuid", "text", "uuid", boolean); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE OR REPLACE FUNCTION "public"."cowork_room_owner_action_v4a"("p_owner_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_target_user_id" "uuid" DEFAULT NULL::"uuid", "p_client_eject_confirmed" boolean DEFAULT false) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."cowork_room_owner_action_v4a"("p_owner_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_target_user_id" "uuid", "p_client_eject_confirmed" boolean) OWNER TO "postgres";

--
-- Name: FUNCTION "cowork_room_owner_action_v4a"("p_owner_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_target_user_id" "uuid", "p_client_eject_confirmed" boolean); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION "public"."cowork_room_owner_action_v4a"("p_owner_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_target_user_id" "uuid", "p_client_eject_confirmed" boolean) IS 'P4-A service-role-only owner room end/member removal transition. Active Daily eject is performed by the custom call owner before membership revocation.';
...
--
-- Name: idx_p4a_identity_approved_user; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "idx_p4a_identity_approved_user" ON "public"."identity_verification_requests" USING "btree" ("user_id", "reviewed_at" DESC) WHERE ("review_status" = 'approved'::"text");


--
-- Name: idx_p4a_presence_room_status_recent; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "idx_p4a_presence_room_status_recent" ON "public"."room_member_presence_state" USING "btree" ("room_id", "presence_status", "last_presence_at" DESC);


--
-- Name: idx_p4a_reports_room_target_created; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "idx_p4a_reports_room_target_created" ON "public"."user_reports" USING "btree" ("target_room_id", "target_user_id", "created_at" DESC) WHERE ("target_room_id" IS NOT NULL);


--
-- Name: idx_p4a_wallet_user_resource_period; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "idx_p4a_wallet_user_resource_period" ON "public"."user_usage_wallets" USING "btree" ("user_id", "resource_key", "period_end" DESC) WHERE ("status" = 'active'::"text");
...
--
-- Name: FUNCTION "cowork_room_friend_action_v4a"("p_actor_user_id" "uuid", "p_target_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_message" "text"); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION "public"."cowork_room_friend_action_v4a"("p_actor_user_id" "uuid", "p_target_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_message" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."cowork_room_friend_action_v4a"("p_actor_user_id" "uuid", "p_target_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_message" "text") TO "service_role";


--
-- Name: FUNCTION "cowork_room_owner_action_v4a"("p_owner_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_target_user_id" "uuid", "p_client_eject_confirmed" boolean); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION "public"."cowork_room_owner_action_v4a"("p_owner_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_target_user_id" "uuid", "p_client_eject_confirmed" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."cowork_room_owner_action_v4a"("p_owner_user_id" "uuid", "p_room_id" "uuid", "p_action" "text", "p_target_user_id" "uuid", "p_client_eject_confirmed" boolean) TO "service_role";
